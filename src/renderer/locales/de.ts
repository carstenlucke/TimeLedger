...
export const de: TranslationKeys = {
  ...
  customers: {
    ...
    createFirst: 'Erstellen Sie Ihren ersten Kunden, um Ihre Projekte zu organisieren',
    ...
    address: 'Adresse',
    notes: 'Notizen',
    deleteConfirm: 'Sind Sie sicher, dass Sie diesen Kunden löschen möchten? Projekte, die mit diesem Kunden verknüpft sind, werden nicht gelöscht.',
    projects: 'Projekte',
    noProjects: 'Keine Projekte mit diesem Kunden verknüpft',
    ...
    notesPlaceholder: 'Zusätzliche Notizen zum Kunden',
    selectCustomer: 'Kunde auswählen',
    createNew: 'Neuen Kunden erstellen',
    selectOrCreate: 'Bestehenden Kunden auswählen oder neu erstellen',
  },
  ...
  invoices: {
    ...
    noMatchingEntries: 'Keine Einträge entsprechen den aktuellen Filtern',
