export const en = {
  ...
  customers: {
    ...
    createFirst: 'Create your first customer to organize your projects',
    ...
    address: 'Address',
    notes: 'Notes',
    deleteConfirm: 'Are you sure you want to delete this customer? Projects linked to this customer will not be deleted.',
    projects: 'Projects',
    noProjects: 'No projects linked to this customer',
    ...
    selectOrCreate: 'Select existing customer or create new',
  },
  ...
  invoices: {
    ...
    noMatchingEntries: 'No entries match the current filters',
